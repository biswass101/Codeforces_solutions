...
void solve()
{
    ...
    // cout <<"Low: ";
    // efr(x, low) cout << x.first << " " << x.second << " ";
    // cout << el;
    // cout << "Up: ";
    // efr(x, up) cout << x.first << " " << x.second << " ";
    // cout << el;
    int i = 0, j = 0;
    while(true)
    {
        if(i == low.size() or j == up.size()) break;
        if(low[i].second < up[j].second)
        {
            cout << low[i].first;
            i++;
        }
    ...
    for(int p = i; p < low.size(); p++) cout << low[p].first;
    for(int p = j; p < up.size(); p++) cout << up[p].first;
    cout << el;
}
signed main()
{
