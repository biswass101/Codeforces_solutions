...
bool lineCheckHorizon(char ch, char grid[][8])
{
    //checkHorizontally
    int cnt = 0;
    fr(i, 0, 8, 1)
...
bool lineCheckVer(char ch, char grid[][8])
{
    //checkVAr
    int cnt = 0;
    fr(i, 0, 8, 1)
...
void solve()
{
    ...
    if(lineCheckHorizon('R', grid)) cout <<  'R' << el;
    // else if(lineCheckHorizon('B', grid)) cout << "2: " <<'B' << el;
    // else if(lineCheckVer('R', grid)) cout << "3: " << 'R' << el;
    else if(lineCheckVer('B', grid)) cout <<  'B' << el;
}
signed main()
{
#ifndef OJ
