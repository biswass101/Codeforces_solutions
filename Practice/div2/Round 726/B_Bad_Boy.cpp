...
void by_the_order_of_peaky_fooking_blinders()
{
    ...
    if(n == 1 and m == 1) cout << "1 1 1 1" << el;
    else
    {
        if(i == 1 and j == 1 and n > m) cout << "2 1" << " " << n << " " << m << el;
        else if(i == 1 and j == 1 and n < m) cout << "1 2" << " " << n << " " << m << el;
        else if(i == n and j == m and n > m) cout << "1 1" << " " << n-1 << " " << m << el;
        else if(i == n and j == m and n < m) cout << "1 1" << " " << n << " " << m-1 << el;
        else cout << "1 1" << " " << n << " " << m << el;
    }
}
signed main()
{
